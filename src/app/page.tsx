...
export default async function Home() {
  ...
  return (
    <div className="card flex-shrink-0 shadow-2xl bg-base-200 w-[500px] sm:w-screen md:w-3/5 lg:w-3/6 p-10 ">
      <div className="card-body hero-content text-center">
        <div className="max-w-md">
          <h1 className="text-5xl font-bold">CV Enhancer AI</h1>
          <div className="py-6">
            ...
            <p className="break-words text-left py-3">
              Sincroniza tus CV con Infojobs o linkedIn y guarda los cambios
              realizados.
            </p>
          </div>
